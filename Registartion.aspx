                                ...
                                <table class="style5" __designer:mapid="7e" align="center">
                                    ...
                                    <tr __designer:mapid="8c">
                                        ...
                                        <td __designer:mapid="8e">
                                            <asp:TextBox width="100%" ID="txtname" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="8c">
                                        <td class="lbl" __designer:mapid="8d">
                                            Roll No:</td>
                                        <td __designer:mapid="8e">
                                            <asp:TextBox width="100%" ID="txtroll" runat="server" CssClass="txt upper-case"></asp:TextBox>
                                        </td>
                                        <td __designer:mapid="90">
                                            &nbsp;</td>
                                    </tr>
                                    <tr __designer:mapid="91">
                                        ...
                                        <td __designer:mapid="93">
                                            <asp:TextBox width="100%" ID="txtmobi" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="96">
                                        ...
                                        <td __designer:mapid="98">
                                            <asp:TextBox width="100%" ID="txtemail" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="ae">
                                        ...
                                        <td __designer:mapid="b0">
                                            <asp:TextBox width="100%" ID="txtadd" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="b3">
                                        ...
                                        <td __designer:mapid="b5">
                                            <asp:TextBox width="100%" ID="txtcity" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="b8">
                                        ...
                                        <td __designer:mapid="ba">
                                            <asp:TextBox width="100%" ID="txtpin" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="bd">
                                        ...
                                        <td __designer:mapid="bf">
                        <asp:DropDownList width="100%" ID="drpcourse" runat="server" CssClass="txtt">
                        </asp:DropDownList>
                                        </td>
                                        <td __designer:mapid="c1">
                                            &nbsp;</td>
                                    ...
                                    <tr __designer:mapid="c2">
                                        ...
                                        <td __designer:mapid="c4">
                                            <asp:TextBox width="100%" ID="txtuname" runat="server" CssClass="txt"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="c7">
                                        ...
                                        <td __designer:mapid="c9">
                                            <asp:TextBox width="100%" ID="txtpass" runat="server" CssClass="txt" TextMode="Password"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr __designer:mapid="cc">
                                        ...
                                        <td __designer:mapid="ce">
                                            <asp:TextBox width="100%" ID="txtcpass" runat="server" CssClass="txt" TextMode="Password"></asp:TextBox>
                                        </td>
