...
<body>
    ...
    <div id="top">
        ...
        <asp:Image ID="Image1" runat="server" Width="15%" Height="100%" ImageUrl="~/images/logo.png" />
	...
	<div class="ws_images">
<a href="#"><img src="images/class1.png" width="100%" height="100%" alt="" title="" id="wows0"/></a>
<a href="#"><img src="images/class2.png" width="100%" height="100%" alt="" title="" id="wows1"/></a>
<a href="#"><img src="images/class3.png" width="100%" height="100%" alt="" title="" id="wows2"/></a>
<a href="#"><img src="images/class4.png" width="100%" height="100%" alt="" title="" id="wows4"/></a>
    ...
    <div id="logoo">
        <table width="100%">
            <tr>
                <td class="log">
                   <marquee BEHAVIOR=ALTERNATE><span class="log">ClassConnect</span></marquee></td>
            </tr>
        </table>
    </div>
    <div id="footer" 
        style="color: #FFFFFF; text-align: center; vertical-align: middle;"> </div>
    </form>
</body>
</html>
